...
class PortfolioSimple {
    ...
    priceByDate(date: Date) {
     ...
     calcAnnualizedReturn(dateFrom: Date, dateTo: Date, periodReturn: number) {
     ...
     calcPeriodInDays(dateFrom: Date, dateTo: Date){
